...
const SettingsModal = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-10">
      <div className="bg-black rounded-lg shadow-xl w-full max-w-md mx-4 text-gray-200">
        ...
        <div className="flex border-b border-gray-700">
          <button
            ...
            className={`flex-1 py-2 px-4 font-semibold ${
              activeTab === 'api' ? 'text-blue-400 border-b-2 border-blue-400' : 'text-gray-400 hover:text-blue-400'
            }`}
          >
            API Settings
          </button>
          <button
            ...
            className={`flex-1 py-2 px-4 font-semibold ${
              activeTab === 'user' ? 'text-blue-400 border-b-2 border-blue-400' : 'text-gray-400 hover:text-blue-400'
            }`}
          >
            User Settings
          </button>
...
const UserSettings = () => (
  <div className="p-4 max-h-96 overflow-y-auto">
    ...
    <div className="mb-4">
      <label className="block text-gray-300 text-sm font-bold mb-2" htmlFor="notifications">
        Notifications
      </label>
      <select
        className="shadow appearance-none border rounded w-full py-2 px-3 bg-gray-700 text-gray-200 leading-tight focus:outline-none focus:shadow-outline"
    ...
    <div className="mb-4">
      ...
      <div className="mt-2">
        <label className="inline-flex items-center">
          <input type="radio" className="form-radio text-blue-600" name="theme" value="light" />
          <span className="ml-2">Light</span>
        </label>
        <label className="inline-flex items-center ml-6">
          <input type="radio" className="form-radio text-blue-600" name="theme" value="dark" />
          <span className="ml-2">Dark</span>
        </label>
      </div>
    </div>
    <div className="mb-4">
      <label className="block text-gray-300 text-sm font-bold mb-2" htmlFor="language">
        Language
      </label>
      <select
        className="shadow appearance-none border rounded w-full py-2 px-3 bg-gray-700 text-gray-200 leading-tight focus:outline-none focus:shadow-outline"
    ...
    <div className="p-4 max-h-96 overflow-y-auto">
      <div className="mb-4">
        ...
        <button
          ...
          id="copy-button"
        >
          <span className="mr-2"><IoCopy /></span>
          Copy
        </button>
      </div>
      ...
      <div className="mb-4">
        <label className="block text-gray-300 text-sm font-bold mb-2" htmlFor="retries">
          Max Retries
        </label>
        <input
          className="shadow appearance-none border rounded w-full py-2 px-3 bg-gray-700 text-gray-200 leading-tight focus:outline-none focus:shadow-outline"
