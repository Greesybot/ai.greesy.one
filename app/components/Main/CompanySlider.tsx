...
export default function InfiniteSlider() {
  return (
    <div className=" mx-auto overflow-hidden bg-transparent w-full before:left-0 before:top-0  before:h-full before:w-[50px] sm:before:w-[100px] before:bg-gradient-to-r before:from- before:to-transparent before:content-['']  after:right-0 after:top-0  after:h-full after:w-[50px] sm:after:w-[100px] after:bg-gradient-to-l after:from- after:to-transparent after:content-['']">
