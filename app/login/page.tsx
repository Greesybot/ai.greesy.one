  ...
  return (
    <>
      ...
      <div className="max-w-sm mx-auto">
        ...
        <p className="text-gray-400 text-center text-sm mb-8">Welcome back! Please log in to continue.</p>
        ...
        <div className="text-gray-500 text-xs text-center mb-4">OR CONTINUE WITH</div>
