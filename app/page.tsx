    ...
    <>
      ...
      <div className="flex w-full flex-col mx-auto z-0">
        <main className="flex flex-col gap-8 items-center sm:items-start">
          ...
          <CompanySlider />
          <div
            className="flex flex-col justify-center items-start sm:items-start sm:justify-between mt-12 sm:mt-24 mx-4 sm:mx-8 lg:mx-16"
            id="greesyguard"
          >
            <h1
              className="text-3xl sm:text-4xl font-extrabold font-sans text-[#ecedef] text-left md:text-left"
